var closestToZero = function (input) {
    ...
    return input.reduce(function (accumulator, value) {
        ...
        if (accumulator === 0)
            return value;
        //If the value is higher than 0 and inferior or equal to the absolute value of the accumulator, we update the value of the accumulator
        else if (value > 0 && value <= Math.abs(accumulator))
            return value;
